// Lightweight client script to render PDFs in an in-page popup overlay
...
function ensureOverlay() {
  ...
  const closeButton = overlay.querySelector<HTMLButtonElement>('[data-pdf-close]');
...
function openPdf(url: string, meta: PdfMeta = {}) {
  const overlay = ensureOverlay();
  const frame = overlay.querySelector<HTMLIFrameElement>('#pdf-frame');
  const titleEl = overlay.querySelector<HTMLElement>('#pdf-title');
  const courseEl = overlay.querySelector<HTMLElement>('#pdf-course');
  const dateEl = overlay.querySelector<HTMLElement>('#pdf-date');
  const authorsEl = overlay.querySelector<HTMLElement>('#pdf-authors');
  const descEl = overlay.querySelector<HTMLElement>('#pdf-description');
...
function setupPdfLinks() {
  const triggers = document.querySelectorAll<HTMLElement>('[data-pdf-load]');
